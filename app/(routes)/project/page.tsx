  ...
  return (
    <div className="w-[90%] mx-auto max-w-[1200px] min-h-screen">
      <div className="flex items-center justify-between my-10">
        <Link
          href="/"
          className="text-white hover:text-black bg-transparent hover:bg-neon rounded-full w-12 h-12 flex items-center justify-center transition-all duration-300"
        >
          <svg
        ...
        <h1 className={`text-5xl font-bold text-center ${heroFont.className}`}>
          Some of our work
        </h1>
            ...
            <div className="rounded-lg shadow-md overflow-hidden">
              <div className="relative aspect-[16/9] overflow-hidden">
                ...
                <div className="absolute inset-0 flex items-center justify-center">
                  <h2
                    className={`text-3xl font-bold text-white opacity-0 transform translate-y-[50px] transition-all duration-300 ease-in-out
