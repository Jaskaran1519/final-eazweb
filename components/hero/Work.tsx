...
const ProjectCard: React.FC<ProjectCardProps> = ({
  ...
  return (
    ...
    >
      ...
      >
        <h2 className="text-3xl md:text-5xl font-bold mb-4 hidden md:block">
          {title}
        </h2>
        <a
          href={href}
          target="_blank"
          rel="noopener noreferrer"
          className="group relative text-neon mt-4 items-center px-7 py-4 bg-transparent border border-neon rounded-full overflow-hidden transition-all duration-300 ease-in-out hover:text-black hidden md:inline-flex"
        >
    ...
    <div className="w-[90%] mx-auto my-10" id="work">
      ...
      <div className="w-full flex justify-center items-center mt-5">
        ...
        >
          ...
          <span
            className="absolute inset-0 bg-neon transform -translate-x-full group-hover:translate-x-0 transition-transform duration-300 ease-in-out"
            style={{
