    ...
    return(
            <div className="w-[90%] mx-auto max-w-[1000px] flex flex-col md:flex-row items-center justify-between gap-12 py-16">
                <div className="w-full md:w-1/2 space-y-6">
                    <h2 className="text-4xl md:text-5xl font-bold">Captivating Video Content</h2>
                    <p className="text-lg text-gray-300">
                        Our videos showcase the essence of our work, bringing ideas to life through stunning visuals and compelling storytelling. Watch and be inspired by our creative process and results.
                    </p>
                    <div className='w-full flex justify-center items-center mt-5 hidden md:flex'>
                        <Link href='/video' className='group relative text-neon mt-4 inline-flex items-center px-7 py-4 bg-transparent border border-neon rounded-full overflow-hidden transition-all duration-300 ease-in-out hover:text-black'>
